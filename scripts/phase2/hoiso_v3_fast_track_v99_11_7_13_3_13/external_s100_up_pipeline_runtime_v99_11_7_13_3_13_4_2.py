...
def activate_external_anchor(
    *,
    ...
    if similarity_replay_error > runtime_numeric_tolerance:
        raise RuntimeError(f"FP32 similarity replay exceeded machine-epsilon bound: {similarity_replay_error}")
    ...
    preflight = {
        "schema": "s100_up_external_anchor_live_preflight_v99_11_7_13_3_13_4_2",
        "decision": "pass_v99_11_7_13_3_13_4_2_live_778_vertices_and_face_hash",
...
def write_post_object_checkpoint(
    ...
    *,
    ...
    torch_module.save({
        "schema": "post_object_before_joint_flow_checkpoint_v99_11_7_13_3_13_4_2",
        "candidate_uid": "s100_up",
    ...
    receipt = {
        "schema": "post_object_before_joint_flow_receipt_v99_11_7_13_3_13_4_2",
        "decision": "pass_v99_11_7_13_3_13_4_2_complete_preflow_hand_object_checkpoint_written",
        "candidate_uid": "s100_up",
