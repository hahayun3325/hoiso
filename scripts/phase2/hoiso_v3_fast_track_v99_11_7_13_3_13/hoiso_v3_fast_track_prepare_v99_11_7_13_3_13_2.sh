...
mapfile -t fast_routes < <(
  find "$HAND_ROOT" -type f \
    -name 'noise_lifecycle_update_sink_and_4090_route_v99_11_7_9_21_7_13_3_12_3_3_3.json' \
    -print | sort
)
mapfile -t handoff_auths < <(
  find "$HAND_ROOT" -type f \
    -name 'noise_lifecycle_update_sink_and_anchor_handoff_source_authorization_v99_11_7_9_21_7_13_3_12_3_3_3.json' \
    -print | sort
)
