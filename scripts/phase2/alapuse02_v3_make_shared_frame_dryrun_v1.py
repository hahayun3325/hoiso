...
glb_path = vis / "alapuse02_v3_shared_frame_dryrun_v1.glb"
...
report_path = met / "alapuse02_v3_shared_frame_dryrun_v1_report.json"
report_path.write_text(json.dumps(report, indent=2))

decision_note = notes / "alapuse02_v3_shared_frame_dryrun_v1_decision_template.md"
decision_note.write_text(f"""# alapuse02_v3 shared-frame dry-run v1 decision
