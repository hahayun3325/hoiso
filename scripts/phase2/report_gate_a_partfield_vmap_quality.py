...
out_path = case_root / "metrics/gate_a_partfield_v2_vmap_quality_report.json"
...
report = {
    ...
    "note": "This is a coordinate-consistent sanity check using the low30k source mesh and vmap-exported named parts."
}
