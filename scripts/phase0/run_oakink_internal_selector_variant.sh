...
BASE_RUN_ID="${1:?Usage: bash run_oakink_internal_selector_variant.sh <base_run_id> <variant_suffix> <selector_choice>}"
VARIANT_SUFFIX="${2:?Usage: bash run_oakink_internal_selector_variant.sh <base_run_id> <variant_suffix> <selector_choice>}"
SELECTOR_CHOICE="${3:?Usage: bash run_oakink_internal_selector_variant.sh <base_run_id> <variant_suffix> <selector_choice>}"

DEBUG_RUN_ID="${BASE_RUN_ID}_${VARIANT_SUFFIX}"

export FOHO_ENABLE_INTERNAL_PHASE42_SELECTOR=1
export FOHO_INTERNAL_PHASE42_SELECTOR_CHOICE="$SELECTOR_CHOICE"

cd /home/fredcui/Projects/FollowMyHold

echo "[INFO] applying exact selector-candidate export patch"
python scripts/phase0/patch_export_internal_selector_candidates.py
python scripts/phase0/patch_internal_selector_exact_export_v5b.py
python scripts/phase0/patch_internal_selector_exact_export_v5c_unique.py
# disabled old/conflicting export patch
# python scripts/phase0/patch_internal_selector_exact_export_v4.py
# disabled broken V5 patch: wrong anchor
# # disabled old/conflicting export patch
# python scripts/phase0/patch_internal_selector_exact_export_v5.py
# disabled broken strict v3 patch
# # disabled old/conflicting export patch
# python scripts/phase0/patch_internal_selector_exact_export_v3.py
...
export FOHO_INTERNAL_SELECTOR_EXPORT_DIR="$FOHO_SELECTOR_DEBUG_DIR"
echo "[INFO] FOHO_INTERNAL_SELECTOR_EXPORT_DIR=$FOHO_INTERNAL_SELECTOR_EXPORT_DIR"
