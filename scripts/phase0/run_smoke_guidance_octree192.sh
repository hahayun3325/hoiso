...
export SRC="$HOME/foho_phase0/runs/smoke_007"
export DST="$HOME/foho_phase0/runs/smoke_013_octree192_guidance"
...
PYTHONPATH=src python3 -m foho.guidance.run \
  ...
  |& tee ~/foho_phase0/logs/phase0_13_smoke_013_octree192_guidance.log
