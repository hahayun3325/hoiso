...
HOME = Path.home()
RUN = HOME / "foho_phase0/runs/oakink000_gpt55_short_selector_auto_frag_v7_truefile"
...
candidates = {
    ...
    "selector_before": RUN / "internal_selector_exports/selector_candidate_before_phase42.ply",
    "selector_after": RUN / "internal_selector_exports/selector_candidate_phase42_before_joint.ply",
    "selector_selected": RUN / "internal_selector_exports/selector_selected_before_joint.ply",
}
...
out = HOME / "foho_phase0/inspection/oakink_000/oakink000_gpt55_stage_contact.csv"
