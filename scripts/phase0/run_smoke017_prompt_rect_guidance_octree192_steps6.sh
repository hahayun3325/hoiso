...
export DST="$HOME/foho_phase0/runs/smoke_017_prompt_rect_guidance_octree192_steps6"
...
echo "===== smoke_017 settings ====="
env | grep -E "FOHO_|PYTORCH_CUDA_ALLOC_CONF|CUDA_VISIBLE_DEVICES|CUDA_HOME" | sort
echo "================================"
...
PYTHONPATH=src python3 -m foho.guidance.run \
  ...
  |& tee ~/foho_phase0/logs/phase0_17_prompt_rect_guidance_octree192_steps6.log
