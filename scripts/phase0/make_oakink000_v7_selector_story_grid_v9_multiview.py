...
for base_id, label in RUNS:
    ...
    render_meshes([before], before_png, "before Phase 4.2", ["0.05"], normalize=True, view="object")
    render_meshes([after], after_png, "after Phase 4.2", ["0.05"], normalize=True, view="object")
    render_meshes([selected], selected_png, "selected before joint", ["0.05"], normalize=True, view="object")

    # Final scene is normalized as a whole scene, keeping hand-object relationship.
    render_meshes([final_obj, final_hand], final_png, "final object + hand", ["0.05", "limegreen"], normalize=True, view="final")
...
out = HOME / "foho_phase0/inspection/oakink_000/oakink000_v7_selector_story_grid_v9_multiview.jpg"
