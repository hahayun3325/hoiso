...
from hy3dgen.shapegen.pipelines_v99_11_7_13_3_13_5_2_1_3 import (
...
import os as _foho_config_os
_foho_base_config_factory = config
def _foho_live_object_only_config(*args, **kwargs):
    _foho_cfg = _foho_base_config_factory(*args, **kwargs)
    if _foho_config_os.environ.get("FOHO_EXTERNAL_HAND_ANCHOR_MODE") == "object_only":
        _foho_cfg.optimization_steps_hand = 0
        _foho_cfg.optimization_steps_scale = 5
        _foho_cfg.optimization_steps_joint = 0
    return _foho_cfg
config = _foho_live_object_only_config
