...
from foho.guidance.h0_read_only_checkpoint_panel_v99_11_7_13_3_13_5_5_1_7_3_5_14_89_6 import H0PanelComplete, ReadOnlyPanelCallback
...
def main():
    ...
    try:
        with tempfile.TemporaryDirectory() as folder:
            ...
            checks = {'panel_written':panel.is_file(), 'panel_size':Image.open(panel).size == (24, 16),
    ...
    payload = {'decision':('pass_v99_11_7_13_3_13_5_5_1_7_3_5_14_89_7_H0_read_only_panel_CPU_closed'
                           if not failed and not errors else
                           'hold_v99_11_7_13_3_13_5_5_1_7_3_5_14_89_7_H0_read_only_panel_CPU'),
